...
stepper_y = Stepper(7, 4, False, board=board_1, board_2=board_2, reference_pin=7, alternative_reference_pin=6)
stepper_x = Stepper(5, 2, True, board=board_1, board_2=board_2, reference_pin=5)
